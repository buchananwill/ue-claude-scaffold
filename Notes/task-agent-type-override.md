...
**Verification:** `npm test` passes. `GET /tasks?agentTypeOverride=container-reviewer` returns only tasks with that
override. The dashboard shows the column with appropriate styling (badge or text).
