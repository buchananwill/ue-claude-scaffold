...
- The SQL is syntactically valid Postgres (statement terminators, balanced parentheses, quoted identifiers where needed). Do not run the migration yet — that is Phase 4.
