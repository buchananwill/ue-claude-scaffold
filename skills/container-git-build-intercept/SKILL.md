...
The build intercept hook commits and pushes your changes to `docker/{agent-name}` on the bare repo _before_ routing the build command to the host. This ensures the host builds against your latest code.
